package com.github.finalmybatis.ext;
...
import com.github.finalmybatis.ext.code.client.ClassClient;
import com.github.finalmybatis.ext.exception.GenCodeException;
import com.github.finalmybatis.ext.exception.MapperFileException;
...
import com.github.finalmybatis.mapper.Mapper;
...
public class MapperLocationsBuilder {
	...
	private static final String DEFAULT_CLASS_PATH = "/finalmybatis/tpl/";

	private Map<String, MapperResourceDefinition> mapperResourceStore = new HashMap<>();

	private FinalmybatisConfig config = new FinalmybatisConfig();
