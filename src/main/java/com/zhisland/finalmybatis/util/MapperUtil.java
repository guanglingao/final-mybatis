package com.zhisland.finalmybatis.util;

import com.zhisland.finalmybatis.PageInfo;
import com.zhisland.finalmybatis.PageResult;
import com.zhisland.finalmybatis.exception.QueryException;
import com.zhisland.finalmybatis.mapper.ReadMapper;
import com.zhisland.finalmybatis.query.Query;
import com.zhisland.finalmybatis.query.param.BaseParam;
import com.zhisland.finalmybatis.support.PageEasyui;
...
public class MapperUtil {
	...
	public static <E, T> PageEasyui<T> queryForEasyuiDatagrid(ReadMapper<E, ?> mapper, Query query, Class<T> clazz) {
    ...
    public static <E> PageEasyui<E> queryForEasyuiDatagrid(ReadMapper<E, ?> mapper, Query query) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <Entity> PageInfo<Entity> query(ReadMapper<Entity, ?> mapper, Object bean) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <Entity> PageInfo<Entity> query(ReadMapper<Entity, ?> mapper, BaseParam searchParam) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <Entity> PageInfo<Entity> query(ReadMapper<Entity, ?> mapper, Query query) {
     ...
     * @return 返回结果类
     */
    public static <Entity, T extends PageResult<Entity>> T query(ReadMapper<Entity, ?> mapper, Query query,
