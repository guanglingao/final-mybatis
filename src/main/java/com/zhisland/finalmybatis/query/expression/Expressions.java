...
import com.zhisland.finalmybatis.query.expression.builder.factory.ExpressionFactory;
import com.zhisland.finalmybatis.query.expression.builder.factory.LikeExpressionFactory;
import com.zhisland.finalmybatis.query.expression.builder.factory.LikeLeftExpressionFactory;
import com.zhisland.finalmybatis.query.expression.builder.factory.LikeRightExpressionFactory;
import com.zhisland.finalmybatis.query.expression.builder.factory.ListExpressionFactory;
import com.zhisland.finalmybatis.query.expression.builder.factory.ValueExpressionFactory;
...
public class Expressions {
    ...
    public static Expression likeLeft(String columnName, String value) {
        return LIKE_LEFT_EXPRESSION_FACTORY.buildExpression(JOINT, columnName, Operator.leftAmbLike, value);
    }
    
    public static Expression likeRight(String columnName, String value) {
        return LIKE_RIGHT_EXPRESSION_FACTORY.buildExpression(JOINT, columnName, Operator.rightAmbLike, value);
    }
